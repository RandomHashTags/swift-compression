...
let package = Package(
    ...
    traits: [
        ...
        .trait(name: "BrotliCompress", description: "Enables Brotli compression for Span<UInt8>."),
        ...
        .trait(name: "BrotliDecompress", description: "Enables Brotli decompression for Span<UInt8>."),
        ...
        .trait(name: "HuffmanCompress", description: "Enables Huffman compression for Span<UInt8>."),
        ...
        .trait(name: "HuffmanDecompress", description: "Enables Huffman decompression for Span<UInt8>."),
        ...
        .trait(name: "LZ77Compress", description: "Enables LZ77 compression for Span<UInt8>."),
        ...
        .trait(name: "LZ77Decompress", description: "Enables LZ77 decompression for Span<UInt8>."),
        ...
        .trait(name: "RunLengthEncodingCompress", description: "Enables RunLengthEncoding compression for Span<UInt8>."),
        ...
        .trait(name: "RunLengthEncodingDecompress", description: "Enables RunLengthEncoding decompression for Span<UInt8>."),
        ...
        .trait(name: "SnappyCompress", description: "Enables Snappy compression for Span<UInt8>."),
        ...
        .trait(name: "SnappyDecompress", description: "Enables Snappy decompression for Span<UInt8>."),
        ...
        .trait(name: "ZlibDeflateCompress", description: "Enables ZlibDeflate compression for Span<UInt8>."),
        ...
        .trait(name: "ZlibDeflateDecompress", description: "Enables ZlibDeflate decompression for Span<UInt8>."),
        ...
        .trait(name: "ZlibGzipCompress", description: "Enables ZlibGzip compression for Span<UInt8>."),
        ...
        .trait(name: "ZlibGzipDecompress", description: "Enables ZlibGzip decompression for Span<UInt8>."),
