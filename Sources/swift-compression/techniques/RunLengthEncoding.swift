...
public extension CompressionTechnique.RunLengthEncoding {
    @inlinable
    static func compress(data: [UInt8], minRun: Int, alwaysIncludeRunCount: Bool) -> [UInt8] {
    ...
    @inlinable
    static func compress(data: [UInt8], minRun: Int, alwaysIncludeRunCount: Bool, bufferingPolicy limit: AsyncStream<UInt8>.Continuation.BufferingPolicy = .unbounded) -> AsyncStream<UInt8> {
    ...
    @inlinable
    static func compress(data: [UInt8], minRun: Int, closure: (_ run: Int, _ runByte: UInt8) -> Void) {
...
public extension Array where Element == UInt8 {
    ...
    /// - Parameters:
    ///   - minRun: the minimum run threshold required to encode repeated bytes.
